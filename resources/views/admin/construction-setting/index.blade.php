...
<section class="section">
    <div class="section-header">
      ...
      <h1>Construction Section Setting </h1>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h4>Update Construction Setting </h4>
            </div>
            <div class="card-body">
                <form action="{{route('admin.construction-setting.update',1)}}" method="POST" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
